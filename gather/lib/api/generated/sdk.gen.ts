 ...
 * Get friend code
 *
 * Get your unique friend code
 */
export const getFriendsFriendCode = <ThrowOnError extends boolean = false>(options?: Options<GetFriendsFriendCodeData, ThrowOnError>) => (options?.client ?? client).get<GetFriendsFriendCodeResponses, GetFriendsFriendCodeErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 */
export const postFriendsFriendCodeRegenerate = <ThrowOnError extends boolean = false>(options?: Options<PostFriendsFriendCodeRegenerateData, ThrowOnError>) => (options?.client ?? client).post<PostFriendsFriendCodeRegenerateResponses, PostFriendsFriendCodeRegenerateErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
