          ...
          <Card marginBottom="$4">
            ...
            <XStack gap="$2">
              <YStack
                ...
                borderWidth={2}
                borderColor={
                  commitmentType === "going" ? "$accent" : "$borderColor"
                }
                backgroundColor={
                  commitmentType === "going" ? "$accentSubtle" : "transparent"
                }
                alignItems="center"
                gap="$2"
              ...
              >
                <Sparkles
                  size={24}
                  color={commitmentType === "going" ? "$accent" : "$colorMuted"}
                />
                <Text
                  fontWeight="600"
                  fontSize={14}
                  color={commitmentType === "going" ? "$accent" : "$color"}
                >
                  I am going
                </Text>
              ...
              <YStack
                ...
                borderWidth={2}
                borderColor={
                  commitmentType === "planning" ? "$accent" : "$borderColor"
                }
                backgroundColor={
              ...
              >
                <CalendarPlus
                  size={24}
                  color={
                    commitmentType === "planning" ? "$accent" : "$colorMuted"
                  }
                />
                <Text
                  fontWeight="600"
                  fontSize={14}
                  color={commitmentType === "planning" ? "$accent" : "$color"}
                >
                  Propose
                </Text>
                <Text fontSize={12} color="$colorMuted" textAlign="center">
            ...
            <ScrollView horizontal showsHorizontalScrollIndicator={false}>
              <XStack gap="$2">
                {activityList.map((activity, index) => (
                  ...
                  >
                    <Text fontSize={24}>{activity.emoji}</Text>
                    <Text
                      fontSize={10}
                      color={
                        selectedEmoji === activity.emoji
        ...
        <Theme name="Card">
          <Card marginBottom="$4">
            <YStack gap="$4">
              ...
              <YStack gap="$2">
                <Text fontWeight="500">Location (optional)</Text>
                <Input
                  placeholder="Where?"
                  placeholderTextColor="$colorMuted"
                  value={location}
          ...
          <Theme name="Card">
            <Card marginBottom="$4">
              <XStack alignItems="center" gap="$2" marginBottom="$3">
                ...
                <Text fontWeight="600">Invite a Group</Text>
              </XStack>
              <YStack gap="$2">
                {availableGroups.map((group) => (
                  ...
                  >
                    <YStack
                      ...
                      backgroundColor={
                        isGroupFullySelected(group) ? "$accent" : "transparent"
                      }
                      alignItems="center"
                      justifyContent="center"
                    >
        ...
        <Theme name="Card">
          <Card marginBottom="$4">
            <XStack
              ...
              marginBottom="$3"
            >
              <Text fontWeight="600">Who is invited?</Text>
